  ...
  return (
    <div className="relative w-full py-[4em]">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
        ...
        <div className="mb-2 text-md text-white md:text-2xl kode_mono_font">
        ...
        <div className="relative inline-block mt-[4em] md:mt-[2em]">
          <button
            className="relative px-8 py-3 font-mono text-black transition-all duration-300 transform bg-white border-[1.8px] border-black kode_mono_font text-md rounded-xl rotate-12 shadow-inner hover:-rotate-3 hover:scale-105"
          >
            Join The Rumble
          </button>
